...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('student_account', function (Blueprint $table) {
            ...
            $table->foreignId('receipt_id')->nullable()->references('id')->on('receipt_student')->onDelete('cascade');
            $table->foreignId('processing_id')->nullable()->references('id')->on('processing_fees')->onDelete('cascade');
            $table->foreignId('payment_id')->nullable()->references('id')->on('payment_student')->onDelete('cascade');
